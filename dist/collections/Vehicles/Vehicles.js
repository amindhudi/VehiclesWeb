...
var syncUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var fullUser, vehicles, allIDs_1, createdProductIDs, dataToUpdate;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    allIDs_1 = __spreadArray([], ((vehicles === null || vehicles === void 0 ? void 0 : vehicles.map(function (vehicle) { return typeof vehicle === 'object' ? vehicle.id : vehicle; })) || []), true);
...
var isAdminOrHasAccess = function () { return function (_a) {
    ...
    if (user.role === 'admin')
        return true;
    var userProductIDs = (user.vehicles || []).reduce(function (acc, vehicle) {
        if (!vehicle)
            return acc;
...
exports.Vehicles = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: config_1.VEHICLE_CATEGORIES.map(function (_a) {
        ...
        },
        {
            ...
            label: "Maker",
            type: "select",
            options: config_1.MAKERS.map(function (_a) {
                var label = _a.label, value = _a.value;
                return ({ label: label, value: value });
            }),
            required: true
